...
//                 <h2 className="text-lg font-semibold text-black mb-4">Filter Data</h2>
...
//               <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 xl:col-span-3">
//                 <h2 className="text-lg font-semibold text-black mb-4">Restaurant Performance</h2>
//                 {loading ? (
//                   <div className="text-center text-gray-600">Loading...</div>
//                 ) : (
//                   <canvas id="restaurantChart" className="w-full h-64"></canvas>
//                 )}
//               </div>

//               {/* Delivery Boy Performance Chart */}
//               <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 xl:col-span-3">
//                 <h2 className="text-lg font-semibold text-black mb-4">Delivery Boy Performance</h2>
//                 {loading ? (
//                   <div className="text-center text-gray-600">Loading...</div>
//                 ) : (
//                   <canvas id="deliveryBoyChart" className="w-full h-64"></canvas>
//                 )}
//               </div>
