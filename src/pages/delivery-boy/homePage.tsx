...
//           <StatusCard isOnline={isOnline} isInZone={isInZone} zoneMessage={zoneMessage} partnerData={partnerData} handleToggleOnline={handleToggleOnline} />
...
import { RootState } from '../../interfaces/delivery-boy/dashboard/root-state.types';
import { deliveryBoyApi } from '../../api/endpoints/deliveryBoyApi';
import { useInHandCashLimit } from '../../hooks/useInHandCashLimit'; // Import the hook
