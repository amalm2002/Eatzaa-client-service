...
import { CheckoutButtonProps } from '../../../interfaces/user/cart/checkout-button.types';
  ...
  return (
    <div className="space-y-3">
      <div className="bg-teal-50 border border-teal-200 rounded-lg p-3">
        ...
        <p className="text-xs text-teal-600 ml-4">123 Main Street, City Center • 25-30 mins</p>
      </div>
