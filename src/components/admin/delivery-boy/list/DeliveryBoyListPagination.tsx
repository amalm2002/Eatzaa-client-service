import { DeliveryBoyListPaginationProps } from "../../../../interfaces/admin/delivery-boys/delivery-boy.types";

const DeliveryBoyListPagination = ({
    itemsPerPage,
    setItemsPerPage,
    currentPage,
    setCurrentPage,
    totalPages,
}: DeliveryBoyListPaginationProps) => {
    return (
...
export default DeliveryBoyListPagination;