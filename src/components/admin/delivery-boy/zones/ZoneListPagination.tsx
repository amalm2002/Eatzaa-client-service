import { ZoneListPaginationProps } from "../../../../interfaces/admin/delivery-boys/zone.types";

const ZoneListPagination = ({
    itemsPerPage,
    setItemsPerPage,
    currentPage,
    setCurrentPage,
    totalPages,
}: ZoneListPaginationProps) => {
    return (
...
export default ZoneListPagination;