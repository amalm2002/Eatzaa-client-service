import { BankDetailsFormProps } from "../../../interfaces/delivery-boy/authentication/bank-details.types";

const BankDetailsForm = ({ userDetails, handleInputChange, errors }: BankDetailsFormProps) => {
    return (
        <>
            <div>
