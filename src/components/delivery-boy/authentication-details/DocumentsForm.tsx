import { DocumentsFormProps } from "../../../interfaces/delivery-boy/authentication/personal-info-form.types";

const DocumentsForm = ({ userDetails, handleInputChange, handleFileChange, errors }: DocumentsFormProps) => {
    return (
        <>
            <div>
