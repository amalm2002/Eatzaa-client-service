import { PersonalInfoFormProps } from "../../../interfaces/delivery-boy/authentication/personal-info-form.types";

const PersonalInfoForm = ({ userDetails, handleInputChange, handleSingleFileChange, errors }: PersonalInfoFormProps) => {
  return (
    <>
      <div>
